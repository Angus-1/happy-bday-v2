<script lang="ts">
  ...
  let open = false;
  let colors = {
    nav: "bg-neutral-300 dark:bg-red-900",
    button: {
      active: /* active takes care of color when you use that button and are at that page section   */
        "bg-primary-200 hover:bg-primary-200 dark:bg-red-600 dark:hover:bg-red-400 shadow-md",
      inactive: 
        "bg-neutral-200 hover:bg-primary-200 dark:bg-red-800 dark:hover:bg-red-400 shadow-md", 
    },
    buttonText: "text-neutral-800 dark:text-yellow-100",
  };
